...
def main():
    ...
    # Create a sub parser for running louvain version
    subparser_louvain = subparsers.add_parser('louvain', parents=[parent_parser], help='simple louvain version')
    mica_louvain.add_louvain_arguments(subparser_louvain)
    ...
    if args.version == 'auto':
        ...
        mica_mds.mica_mds(args)
    elif args.version == 'louvain':
        logging.info('Start louvain mode...')
        mica_louvain.mica_louvain(args)
    else:
