...
#%% MICA
umap_embed_file = '/Users/lding/Documents/MICA/Manuscript/Figures/Silhouette/Chung/mds_1_3_silhouette/'\
...
#%%
out_dir = '/Users/lding/Documents/MICA/Manuscript/Figures/Silhouette/Chung/mds_1_3_silhouette'

#%%
labels = merged['label_y']
...
#%% Seurat
umap_embed_file = '/Users/lding/Documents/MICA/Manuscript/Figures/Silhouette/Chung/Seurat/Chung_Seurat_UMAP.txt'
umap_embed = pd.read_csv(umap_embed_file, sep='\t', index_col=0)

#%%
# umap_embed.index = list(range(0, 515))

#%%
merged = true_label.merge(umap_embed, left_on='cell', right_index=True)

#%%
out_dir = '/Users/lding/Documents/MICA/Manuscript/Figures/Silhouette/Chung/Seurat'
...
#%%
vi.silhouette_plot(labels, merged.loc[:, ['UMAP_1', 'UMAP_2']], 5, silhouette_avg, out_dir, ss_lower_bound=-0.6,
                   ss_upper_bound=1.0)
...
#%% Scanpy
umap_embed_file = '/Users/lding/Documents/MICA/Manuscript/Figures/Silhouette/Chung/Scanpy/Chung_Scanpy_UMAP.txt'
umap_embed = pd.read_csv(umap_embed_file, sep='\t', index_col=0)
...
#%%
out_dir = '/Users/lding/Documents/MICA/Manuscript/Figures/Silhouette/Chung/Scanpy'
...
#%% SC3
umap_embed_file = '/Users/lding/Documents/MICA/Manuscript/Figures/Silhouette/Chung/SC3/Chung_SC3_euclidean_laplacian_UMAP.txt'
umap_embed = pd.read_csv(umap_embed_file, sep='\t', index_col=0)
...
#%%
out_dir = '/Users/lding/Documents/MICA/Manuscript/Figures/Silhouette/Chung/SC3'
