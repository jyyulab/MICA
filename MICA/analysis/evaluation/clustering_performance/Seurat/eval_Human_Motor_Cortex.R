...
cortex <- subset(cortex, subset = nFeature_RNA > 200 & nFeature_RNA < 2500 & percent.mt < 5)
...
cortex <- FindClusters(cortex, resolution = 1.5)
...
print("ARI: ")
print(adj.rand.index(merged$subclass_label, merged$cortex.seurat_clusters))
