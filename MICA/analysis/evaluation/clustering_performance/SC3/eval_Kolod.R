...
write.table(euclidean_laplacian_umap$layout, file='/Users/lding/Documents/MICA/Manuscript/Figures/Silhouette/Kolod/SC3/Kolod_SC3_euclidean_laplacian_UMAP.txt', sep='\t')
